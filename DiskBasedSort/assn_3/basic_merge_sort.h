...
#ifndef basic_merge_sort_h
#define basic_merge_sort_h
...
namespace assn_3 {
    ...
    {
    public:
        BasicMergeSort(const char* input_file_name, const char* output_file_name, int input_buffer_size, int output_buffer_size)
        {
